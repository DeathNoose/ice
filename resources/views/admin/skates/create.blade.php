<!-- resources/views/admin/skates/create.blade.php -->
@extends('admin.layouts.app')

@section('title', 'Добавление коньков - Админ-панель')

@section('content')
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 style="color: #3A3A3A;">Добавление новых коньков</h2>
    ...
    <div class="card" style="background: #FFFFFF; border-radius: 20px; box-shadow: 0 10px 30px rgba(162,192,212,0.2); border: 1px solid #D6E4F0;">
        <div class="card-body p-5">
            <form action="{{ route('admin.skates.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               name="brand" 
                               value="{{ old('brand') }}" 
                               placeholder="Например: Bauer, CCM, Graf"
                               required
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" 
                               ...
                               name="model" 
                               value="{{ old('model') }}" 
                               placeholder="Например: RX5, RS, Elite"
                               required
                               style="border: 2px solid #D6E4F0; border-radius: 10px; padding: 12px;">
                        @error('model')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-6">
                        ...
                        <small class="text-muted">Рекомендуемый размер: 500x500px</small>
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="4"
                                  placeholder="Краткое описание коньков, особенности, материалы..."
                                  style="border: 2px solid #D6E4F0; border-radius: 10px; padding: 12px;">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
