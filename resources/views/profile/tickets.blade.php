<!-- resources/views/profile/tickets.blade.php -->
@extends('layouts.app')

@section('title', 'Мои билеты - Ice Arena')
            ...
            <div class="card border-0 shadow-lg" style="border-radius: 20px; overflow: hidden;">
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{ route('profile.tickets') }}" class="list-group-item list-group-item-action d-flex align-items-center p-3 active" 
                        ...
                        <a href="{{ route('profile.bookings') }}" class="list-group-item list-group-item-action d-flex align-items-center p-3" 
                           style="border: none; border-bottom: 1px solid #D6E4F0;">
                ...
                <div class="card-body p-5">
                                ...
                                <div class="card h-100 border-0" style="background: #D6E4F0; border-radius: 15px; transition: all 0.3s;">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            <h5 class="mb-0" style="color: #3A3A3A;">Билет #{{ $ticket->id }}</h5>
                                            <span class="badge" style="
                                                background: @if($ticket->status == 'paid') #A2C0D4 
                                                          @elseif($ticket->status == 'used') #cce5ff 
                                                          @else #FFFFFF @endif;
                                                color: @if($ticket->status == 'paid') white 
                                                       @elseif($ticket->status == 'used') #004085 
                                                       @else #3A3A3A @endif;
                                                padding: 8px 12px;
                                                border-radius: 8px;">
                                                ...
                                                @else
                                                    <i class="fas fa-check-double me-1"></i>Использован
                                                @endif
                                            </span>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <p class="mb-1" style="color: #3A3A3A;">
                                                <i class="fas fa-user me-2" style="color: #A2C0D4; width: 18px;"></i>
                                                {{ $ticket->full_name }}
                                            </p>
                                            <p class="mb-1" style="color: #3A3A3A;">
                                                <i class="fas fa-phone me-2" style="color: #A2C0D4; width: 18px;"></i>
                                                {{ $ticket->phone }}
                                            </p>
                                            <p class="mb-1" style="color: #3A3A3A;">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="{{ route('ticket.show', $ticket) }}" class="btn" 
                                        ...
                                        <div class="mt-3 pt-3" style="border-top: 1px solid #FFFFFF;">
                                            <a href="{{ route('payment.process', ['ticket' => $ticket->id]) }}" class="btn w-100" 
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h5 style="color: #3A3A3A;">У вас пока нет билетов</h5>
                            <p style="color: #3A3A3A; opacity: 0.7;">Купите билет, чтобы посетить наш каток</p>
                            <a href="{{ route('ticket.create') }}" class="btn mt-3" 
